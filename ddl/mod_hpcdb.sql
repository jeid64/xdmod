...
INSERT INTO `hpcdb_fields_of_science` VALUES (1, NULL, 'Unknown', 'Unknown');
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `hpcdb_jobs` (
  ...
  `account_id` int(11) NOT NULL,
  `local_jobid` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`job_id`),
  UNIQUE KEY `uk_jobs` (`resource_id`,`local_jobid`,`submit_time`),
