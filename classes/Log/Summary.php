 ...
 * Log summary class.
 *
 * Stores data summarizing the most recent invocation of a process that
 * was logged using a specified "ident".
 *
...
class Summary
{
     ...
     */
    protected function __construct($ident = null)
    {
        $this->ident = $ident;
    ...
    public function factory($ident)
    {
        return new Summary($ident);
    }
