...
class CenterDirectorRole extends \User\AuthenticatedRole
{
    ...
    public function getFormalName()
    {
        ...
        $center_data = $pdo->query("SELECT short_name description FROM modw.organization WHERE id=$active_center_id");
    ...
    public function enumCenterStaffMembers()
    {
        ...
        $query = "SELECT u.id, CONCAT(u.last_name, ', ', u.first_name) as name " .
                 ...
                 "AND urp.param_name = 'provider' AND urp.param_value='$organization_id'";

        $staffMembers = $pdo->query($query);
