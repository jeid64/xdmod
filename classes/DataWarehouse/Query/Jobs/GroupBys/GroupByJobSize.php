...
{	
	...
	{
		parent::__construct('jobsize', array('avg_waitduration_hours','sem_avg_waitduration_hours'), 
		"
			select 
				gt.id, 
	...
	public function applyTo(\DataWarehouse\Query\Query &$query, \DataWarehouse\Query\Model\Table $data_table, $multi_group = false)
	{
		...
		$query->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($data_table,'processorbucket_id'),
													'=',
