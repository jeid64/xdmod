...
class GroupByPIInstitution extends \DataWarehouse\Query\Jobs\GroupBy
{
	...
	{		
		...
		$query->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($this->pi_person_table,'person_id'),
													'=',
		...
		$query->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition($organization_id_field,
													'=',
													new \DataWarehouse\Query\Model\TableField($this->pi_person_table,'organization_id')));											
