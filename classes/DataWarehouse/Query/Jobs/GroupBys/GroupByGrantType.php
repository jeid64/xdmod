...
class GroupByGrantType extends \DataWarehouse\Query\Jobs\GroupBy
{
	...
	public function applyTo(\DataWarehouse\Query\Query &$query, \DataWarehouse\Query\Model\Table $data_table, $multi_group = false)
	{
		...
		$query->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($this->account_table,  'id'),
													'=',
													$datatable_account_id_field
													));
		$query->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($this->account_table,  'granttype_id'),
													'=',
													$id_field
													));
