...
class Raw extends \DataWarehouse\Query\Query
{
								...
								$single_stat = false)
	{
		...
		$this->setRealmName('Jobs');
		
		$this->setDuration($start_date, $end_date, $db_tablename);	
		
		/*$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($this->_data_table, 'resourcetype_id'), 
													'in',
													new \DataWarehouse\Query\Model\Field("(1,2,3,6,7)")													
													)
								);	
		*/
	...
	protected function setDuration($start_date, $end_date, $db_tablename)
	{
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($dataTable,"resource_id"), 
													'=',
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($dataTable,"person_id"), 
													'=',
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($dataTable,"fos_id"), 
													'=',
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($dataTable,"account_id"), 
													'=',
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\TableField($dataTable,"principalinvestigator_person_id"), 
													'=',
		...
		$this->addWhereCondition(new \DataWarehouse\Query\Model\WhereCondition(new \DataWarehouse\Query\Model\Field("end_time_ts"), 
													'>=',
