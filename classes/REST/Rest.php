   ...
   class Rest {
      ...
      public static function internalRequest($internalCall, $callArguments = array(), $user = NULL, $api_key = NULL) {
         ...
         try {
            ...
            // Ensure that the call is 'local' (internal). Web-based scripts which call Rest::internalRequest() will inevitably 
            // make $parser->parseRequest() assign a non-local IP address to the respective RestElements class property.
            // The following line overwrites that assignment:
            ...
            if ($user != NULL) {
               ...
               // an IP address of 127.0.0.1, will allow XDSessionManager to defer to XDUser for token-to-user resolution (using moddb.Users).
