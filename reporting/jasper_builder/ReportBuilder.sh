...
function getSetting {
   ...
   sed -n -e "/\[$SECTION\]/,/\[/ p" $SETTINGS | grep $PARAM | sed "s/$PARAM = '\(.*\)'/\1/"
...
BASEPATH=$(getSetting "reporting" "base_path")
...
# Set up java classpath string =====================================
   ...
   path="$BASEPATH/"
   path="$path:$BASEPATH/commons-beanutils-1.8.0.jar"
   path="$path:$BASEPATH/commons-logging-1.0.4.jar"
   path="$path:$BASEPATH/jasperreports-3.7.6.jar"
   path="$path:$BASEPATH/commons-collections-2.1.1.jar"
   path="$path:$BASEPATH/core.jar"
   path="$path:$BASEPATH/poi-3.6.jar"
   path="$path:$BASEPATH/commons-digester-1.7.jar"
   path="$path:$BASEPATH/iText-2.1.7.jar"
   path="$path:$BASEPATH/xalan.jar"
