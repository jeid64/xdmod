...
XDMoD.Admin.RoleGrid = Ext.extend(Ext.grid.EditorGridPanel,  {
   ...
   initComponent: function(){
      ...
      centerAssignments[XDMoD.Admin.Roles.CENTER_DIRECTOR] = new Array();
      centerAssignments[XDMoD.Admin.Roles.CENTER_STAFF] = new Array();
...
XDMoD.Admin.RoleGrid.CenterSelector = Ext.extend(Ext.menu.Menu,  {
   ...
   initComponent: function(){
      ...
      if (self.defaultSelections == undefined) self.defaultSelections = new Array();
      if (self.primarySelection == undefined) self.primarySelection = -1;
      
      var centerAssignments = new Array();
