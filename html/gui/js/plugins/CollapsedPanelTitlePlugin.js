...
Ext.ux.collapsedPanelTitlePlugin = function (overrideTitle) {
   ...
   this.renderVerticalText = function(t) {
      ...
      if (Ext.isIE == true) {
         ...
         if (Ext.isIE9 == true) letter_spacing = 'letter-spacing: 2px; ';
         
         markup = '<div style="width: 200px; padding-left: 5px; padding-bottom: 4px; filter: progid:DXImageTransform.Microsoft.BasicImage(rotation=1);">' +
                  '<span style="' + letter_spacing + 'font-family: tahoma,arial,verdana,sans-serif; font-weight: bold; font-size: 11px">' + t + '</span>' +
                  '</div>'
