...
XDMoD.Module.AppKernelExplorer = function (config) {

    XDMoD.Module.AppKernelExplorer.superclass.constructor.call(this, config);

};

// ===========================================================================

Ext.extend(XDMoD.Module.AppKernelExplorer, XDMoD.PortalModule, {
    ...
    initComponent: function () {
        ...
        this.chartSwapXYField = new Ext.form.Checkbox({
            ...
            listeners: {
                ...
                'check': function (checkbox, check) {
                    ...
                    XDMoD.TrackEvent('App Kernel Explorer', 'Clicked on the Invert Axis checkbox', Ext.encode({checked: check}));
        ...
        var toggleChangeIndicator = new Ext.Button({
            ...
            pressed: true,
            tooltip: 'When this option is checked, each app kernel data series plot will show an exclamation point icon if and whenever the system detects an environment change where the app kernel is being ran.'
        ...
        XDMoD.Module.AppKernelExplorer.superclass.initComponent.apply(this, arguments);

    } //initComponent

}); //XDMoD.Module.AppKernelExplorer