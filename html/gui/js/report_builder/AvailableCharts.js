   ...
   minSize: 500,
	...
	initComponent: function(){
         ...
         var conn = new Ext.data.Connection;
			...
			conn.request({
               ...
               if (success) {
                  ...
                  Ext.MessageBox.alert('Chart Pool', 'There was a problem regarding the chart pool');
      ...
      var gridEmptyText = '<b>No charts have been added.</b><br/><br/>' +
                          ...
                          '<div style="padding: 5px; background-color: #faffc2; border: 1px solid #ccc">' + 
                          'Go to the <b>Usage Explorer</b> tab to generate a chart, then ' +
                          'check the <b>Available For Report</b> checkbox in the top toolbar.</div>' +
                     ...
                     conn.request({
                        ...
                        callback: function(options, success, response) {
                           ...
                           if (success) {
                              ...
                              for (module_id in XDMoD.Reporting.CheckboxRegistry) {
