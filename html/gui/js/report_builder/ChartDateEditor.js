...
XDMoD.Reporting.ChartDateEditor = Ext.extend(Ext.Window,  {
   ...
   // -----------------------------
	...
	initComponent: function(){
      ...
      this.start_date_field = new Ext.form.DateField({ height: 30, width: 90, format: 'Y-m-d' });
      this.end_date_field = new Ext.form.DateField({ height: 30, width: 90, format: 'Y-m-d' });   
