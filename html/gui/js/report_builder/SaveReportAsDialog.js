//XDMoD.SaveReportAsDialog = Ext.extend(Ext.menu.Menu,  {
XDMoD.SaveReportAsDialog = Ext.extend(Ext.Window, {
   ...
   initComponent: function(){
      ...
      var txtReportFileName = new Ext.form.TextField({
      //var txtReportFileName = new XDMoD.LimitedField({
            ...
            items: [
               ...
               new Ext.Button({
                  ...
                  handler: function(){
                     ...
                     if (txtReportFileName.getValue().length == 0) {
                        presentOverlay(false, 'You must specify a filename');
                        return;
                     }
