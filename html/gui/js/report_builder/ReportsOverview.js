                  ...
                  conn.request({
                     ...
                     callback: function(options, success, response) {
                        if (success)
                           ...
                           Ext.MessageBox.alert('Report Pool', 'There was a problem regarding the report pool');
                     }
            ...
            callback: function(options, success, response) {
               ...
               if (success) { 
                  ...
                  if (reportData.success == false) {
                     Ext.MessageBox.alert('Report Creator', reportData.message);
                     return;
                  }
                  ...
                  Ext.MessageBox.alert('Report Creator', 'There was a problem trying to build a report from this template');
            ...
            items: [
...

               {
                  ...
                  handler: function() {
                     ...
                     var pendingSelections = new Array();
