...
Ext.ux.grid.CheckColumn.prototype ={
    ...
    onMouseDown : function(e, t){
        if(Ext.fly(t).hasClass(this.createId())){
			...
			if(this.disabledDataIndex) 
			{
				if(record.data[this.disabledDataIndex])
				{
					if(this.enabledNotDataIndex)
					{
						if(!record.data[this.enabledNotDataIndex])
						{
			...
			this.checkchange(record, this.dataIndex, record.data[this.dataIndex]);
