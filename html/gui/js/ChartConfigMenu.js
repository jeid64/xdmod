...
Ext.extend(CCR.xdmod.ui.ChartConfigMenu, Ext.menu.Menu, {
    ...
    onDatasetItemCheck: function (item, checked) {
        ...
        /*if(this.displayParam == 'datasheet' || !checked)
		{
			var dataCombineMethodItem = this.items.find(function(i)
			{
				return i.group == 'data_combine_method' && i.param == 'auto';
			}
			);
        ...
        if (!checked && (this.displayParam == 'area' /* || this.displayParam == 'line' */ )) {
            var displayTypeItem = this.items.find(function (i) {
    ...
    onDisplayItemChange: function (item, e) {
        if (item && item.param) {
            ...
            //if(this.displayParam == 'pie' || this.displayParam == 'h_bar')
            //{
            //	this.setDatasetParam('aggregate');
            //}

            //this.legendItem.setVisible(this.displayParam == 'pie' || this.datasetParam == 'timeseries');
    ...
    initComponent: function () {
        ...
        this.datasheetDisplayType = new CCR.xdmod.ui.CustomCheckItem({
            ...
            scope: this,
            text: 'Datasheet',
            param: 'datasheet', //iconCls: 'dataset', 
            checked: this.displayParam == 'datasheet',
            group: 'display_type',
            handler: this.onDisplayItemChange
        });
        this.jobsDisplayType = new CCR.xdmod.ui.CustomCheckItem({
            id: 'jobs_display_type' + this.id,
            scope: this,
            text: 'Jobs',
            param: 'jobs', //iconCls: 'dataset', 
            checked: this.displayParam == 'jobs',
            group: 'display_type',
            handler: this.onDisplayItemChange
        });
        ...
        this.autoCombineMethod = new CCR.xdmod.ui.CustomCheckItem({
            ...
            scope: this,
            text: 'Auto',
            param: 'auto', // iconCls: 'auto_combine_method',
        ...
        this.sideCombineMethod = new CCR.xdmod.ui.CustomCheckItem({
            ...
            disabled: false,
            text: 'Side',
            param: 'side', //iconCls: 'side_combine_method', 
        ...
        this.stackCombineMethod = new CCR.xdmod.ui.CustomCheckItem({
            ...
            disabled: true,
            text: 'Stack',
            param: 'stack', //iconCls: 'stack_combine_method', 
        ...
        this.percentageCombineMethod = new CCR.xdmod.ui.CustomCheckItem({
            ...
            disabled: true,
            text: 'Percentage',
            param: 'percentage', // iconCls: 'percentage_combine_method', 
        ...
        this.overlayCombineMethod = new CCR.xdmod.ui.CustomCheckItem({
            ...
            disabled: true,
            text: 'Overlay',
            param: 'overlay', //iconCls: 'overlay_combine_method', 
