<?php
   ...
   if (preg_match('/MSIE/', $_SERVER['HTTP_USER_AGENT'])
	...
	$controller->registerOperation('get_custom_charts');
	$controller->registerOperation('get_my_reports');
	$controller->registerOperation('get_menus');
	$controller->registerOperation('get_disabled_menus');
	$controller->registerOperation('get_charts');
	$controller->registerOperation('get_data');
	$controller->registerOperation('get_public');
	$controller->registerOperation('get_jobs');		
	$controller->registerOperation('get_param_descriptions');			
	$controller->registerOperation('test');
