<?php
   ...
   session_write_close();
	...
	$controller->registerOperation('read_queries');
	$controller->registerOperation('create_query');
	$controller->registerOperation('update_query');
	$controller->registerOperation('delete_query');
