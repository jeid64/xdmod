...
try
{
	$queryFields = 
	array(
		'project_number'  => array('type' => 'string', 'column' => array('header' => 'Project', 'sortable' => true, 'editable' => false, 'align' => 'left', 'xtype' => 'gridcolumn', 'width' => 100)),
	...
	where
		person_id is NULL and org_id is NULL and tas_pub_id is NULL '.(isset($searchClause)? $searchClause  : '');
