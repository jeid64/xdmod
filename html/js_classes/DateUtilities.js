      ...
      switch(formal_timeframe.toLowerCase()) {
         ...
         default:
            ...
            if (formal_timeframe.match(/^\d{4}$/) != null && formal_timeframe >= 1900) {
               ...
               start_date.setFullYear(parseInt(formal_timeframe));
               start_date.setMonth(0);
               start_date.setDate(1);
            
               end_date.setFullYear(parseInt(formal_timeframe));
            ...
            // 30/60/90/etc. day
               ...
               start_date.setDate(start_date.getDate() - parseInt(formal_timeframe.split(' ')[0]));
            ...
            // 1/2/5/etc. year
               ...
               start_date.setFullYear(start_date.getFullYear() - parseInt(formal_timeframe.split(' ')[0]));
